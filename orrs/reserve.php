...
<div class="content py-5">
    <div class="card rounded-0 card-outline card-dark shadow">
        <div class="card-header rounded-0">
           
            <h5 class="card-title" style="margin-top:22px" >ملىء استمارة الحجز</h5>
        </div>
        <div class="card-body rounded-0" >
            <div class="callout border-dark rounded-0">
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <dl>
                            <dt class="text-muted" style="text-align:right">رمز الجدول:</dt>
                            <dd class="pl-3" style="text-align:right"><b><?= isset($code) ? $code : 'N/A' ?></b></dd>
                            <dt class="text-muted" style="text-align:right">الجدول:</dt>
                            <dd class="pl-3" style="text-align:right"><b><?= isset($date_schedule) && !is_null($date_schedule) ? date("M d, Y", strtotime($date_schedule)) : "Everday" ?> <?= isset($time_schedule) ? date("h:i A", strtotime($time_schedule)) : "--:-- --" ?></b></dd>
                        </dl>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <dl>
                            <dt class="text-muted" style="text-align:right">من:</dt>
                            <dd class="pl-3" style="text-align:right"><b><?= isset($route_from) ? $route_from : "N/A" ?></b></dd>
                            <dt class="text-muted" style="text-align:right">الى:</dt>
                            <dd class="pl-3" style="text-align:right"><b><?= isset($route_to) ? $route_to : "N/A" ?></b></dd>
                        </dl>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <dl>
                            <dt class="text-muted">سعر تذكرة درجة اولى:</dt>
                            <dd class="pl-3"><b><?= isset($first_class_fare) ? $first_class_fare : '--.--' ?></b></dd>
                            <dt class="text-muted">سعر التذكرة الاقتصاديه:</dt>
            ...
            <form action="" id="reserve-form">
                ...
                <div class="form-group col-md-4 col-sm-6 <?= isset($date_schedule) && !is_null($date_schedule) ? 'd-none' : '' ?>">
                    <label for="date" class="form-group" style="text-align:right">تاريخ الجدول</label>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            <select class="form-control form-control-sm form-control-border" name="seat_type" required>
                                ...
                                <option value="1">درجة اولى</option>
                                <option value="2">اقتصاديه</option>
                            </select>
                            <small class="text-muted mx-2">المقعد</small>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            <input type="text" class="form-control form-control-sm form-control-border text-right" name="fare_amount" readonly>
                            <small class="text-muted mx-2">سعر التذكره</small>
                        </div>
                    </div>
                </div> 
                <!-- List Group -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group text-right">
                                    <button class="btn btn-danger btn-sm btn-flat btn-remove" type="button"><i class="fa fa-trash"></i> ازاله</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-between my-2">
                    <div class="form-group">
                        <button class="btn btn-sm btn-info btn-flat" type="button" id="add_item"><i class="fa fa-plus"></i> اضف راكب</button>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-sm btn-dark btn-flat">حجز التذكره</button>
                    </div>
                </div>
                <!-- List Group -->
