...
<div class="content py-5">
    <div class="card rounded-0 card-outline card-dark shadow">
        <div class="card-header rounded-0">
            <h5 class="card-title" style="margin-top:22px">التذاكر المحجوزه</h5>
            <div class="card-tools">
                <button class="btn btn-sm btn-flat btn-success" id="print" style="margin-top:22px"><i class="fa fa-print"></i> طباعه</button>
            </div>
        </div>
