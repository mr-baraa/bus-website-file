    ...
    <div class="row my-5 ">
        <div class="col-md-5">
            <div class="card card-outline card-navy rounded-0 shadow">
                <div class="card-header" style="margin-top: 61px;">
                    <h4 class="card-title">معلومات التواصل</h4>
                </div>
                <div class="card-body rounded-0">
                    <dl>
                        <dt class="text-muted"><i class="fa fa-envelope"></i> البريد الالكتروني</dt>
                        <dd class="pl-4"><?= $_settings->info('email') ?></dd>
                        <dt class="text-muted"><i class="fa fa-phone"></i> رقم الهاتف</dt>
                        <dd class="pl-4"><?= $_settings->info('contact') ?></dd>
                        <dt class="text-muted"><i class="fa fa-map-marked-alt"></i> العنوان</dt>
        ...
        <div class="col-md-7">
            <div class="card rounded-0 card-outline card-navy shadow" >
                <div class="card-body rounded-0" style="margin-top: 61px;">
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <small class="px-3 text-muted">الاسم بالكامل</small>
                            </div>
                            <div class="col-md-6">
                                ...
                                <small class="px-3 text-muted">رقم الهاتف</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <small class="px-3 text-muted">البريد الالكتروني</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
                                <small class="text-muted">الرساله</small>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 text-center">
                                <button class="btn btn-primary rounded-pill col-5">ارسال الرساله</button>
                            </div>
                        </div>
                    </form>
                </div>
